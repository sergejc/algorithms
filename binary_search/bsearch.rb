...
raise "First test is wrong" unless binary_search(1, [1, 5, 6, 9, 12]) == 0
raise "Second test is wrong" unless binary_search(12, [1, 5, 6, 9, 12]) == 4
raise "Third test is wrong" unless binary_search(6, [1, 5, 6, 9, 12]) == 2
